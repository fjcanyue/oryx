...
- In the editor, with nothing selected, `Ctrl+C` copies the line the caret is on and `Ctrl+X` cuts it, as in VS Code and Sublime Text. Paste at the start of a line to repeat the line or move it. Before, both keys did nothing without a selection.
